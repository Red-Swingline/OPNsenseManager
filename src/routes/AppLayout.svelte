<script lang="ts">
  ...
  import { authStore } from '$lib/stores/authStore';  // Make sure this path is correct
  ...
  <aside class="hidden lg:flex flex-col w-64 bg-base-100">
    ...
    <nav class="flex-1 overflow-y-auto">
      <ul class="p-2 space-y-2">
        <li>
          <a href="/" class="flex items-center p-2 space-x-3 rounded-md hover:bg-base-200 transition-colors duration-200">
        ...
        <li>
          <a href="/devices" class="flex items-center p-2 space-x-3 rounded-md hover:bg-base-200 transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24">
        ...
        <li>
          <a href="/settings" class="flex items-center p-2 space-x-3 rounded-md hover:bg-base-200 transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24">
